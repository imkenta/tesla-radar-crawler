...
// 窗取 5 分鐘：2026-08-30 SOUTH 實戰 503 風暴約每 1-2 分鐘一次 5xx，3 次約
// 在風暴開始 2-3 分鐘內觸發升級；間歇性 500（數十分鐘一次）永遠達不到門檻。
const SERVER_ERROR_STORM_THRESHOLD = 3;
const SERVER_ERROR_STORM_WINDOW_MS = 5 * 60 * 1000;
