...
const SOURCES = [
  ...
  {
    name: 'taichung-mobile',
    url: 'https://newdatacenter.taichung.gov.tw/api/v1/no-auth/resource.download?rid=98a68386-8664-4004-a00b-5318e826646e',
    parse: parseTaichungMobile,
    fallbackUrls: [],
  },
  {
...
function logClassificationCounts(sourceName, records) {
  ...
  for (const record of records) counts[record.speed_status] = (counts[record.speed_status] || 0) + 1;
  console.error(
